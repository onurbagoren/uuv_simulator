    ...
    const std::string &description)
{
  ...
  sdf::ElementPtr dynSdf = sdfParsed.Root()->GetElement("model")->GetElement("plugin")->GetElement("dynamics");

  std::shared_ptr<gazebo::Dynamics> dyn;
  dyn.reset(gazebo::DynamicsFactory::GetInstance().CreateDynamics(dynSdf));
